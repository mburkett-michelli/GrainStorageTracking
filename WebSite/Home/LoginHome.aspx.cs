...
public partial class _Default : Page
{
    ...
    {
        GetPictures("http://192.168.11.204/Streaming/channels/1/picture", Outbound);

        GetPictures("http://192.168.11.203/Streaming/channels/1/picture", Inbound);



        this.ImageIn.ImageUrl = "~/image/" + Inbound + "?time=" + DateTime.Now.ToString();
        this.ImageOut.ImageUrl = "~/image/" + Outbound + "?time=" + DateTime.Now.ToString();
